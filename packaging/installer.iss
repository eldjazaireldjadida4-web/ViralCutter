; ViralCutter — Inno Setup installer script
...
#define MyAppPublisher "ViralCutter"
#define MyAppURL "https://github.com/eldjazaireldjadida4-web/ViralCutter"
#define MyAppExeName "ViralCutter.exe"
...
OutputDir=..\dist
OutputBaseFilename=ViralCutter-Setup-{#MyAppVersion}
Compression=lzma2
