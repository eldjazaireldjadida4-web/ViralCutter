...
| 🥇 | **ملف .exe واحد** (PyInstaller) | أكبر عائق للاستخدام الواسع على ويندوز |
| 🥈 | **الرفع المباشر لـ YT/TikTok** + بوابة رفض إجبارية قبل الرفع | `publish_blocklist.json` جاهز للاستهلاك |
| 🥈 | **حذف الصمت/الحشو (Jump Cuts)** | أعلى عائد على الجودة |
| 🥈 | **زوم Punch-in** | ستايل المقاطع الفيروسية |
| 🥉 | **حلقة تغذية راجعة من الضربات** | المستخدم يعلّم الأداة أنماطاً جديدة |
| 🥉 | **موسيقى خلفية + Auto-Duck**، أبعاد غير 9:16، مثبتات Linux/Mac، تحديث تلقائي للبرنامج | مذكورة في README خارطة الطريق |
